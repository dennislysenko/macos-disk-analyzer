...
CLEANUP_RULES = [
    ...
    CleanupRule(
        ...
        "high",
        "review",
        "WhatsApp media attachments — real conversations and shared media",
        "Use WhatsApp → Settings → Storage and Data → Manage Storage to selectively delete",
        "whatsapp_cleanup",
    ),
    CleanupRule(
        "*.logicx",
        ...
        "high",
        "review",
        "Logic Pro project — original user audio work and sessions",
        "Open in Logic Pro to review and export bounces before deleting",
    ),
    CleanupRule(
    ...
    CleanupRule(
        ...
        "medium",
        "review",
        "Installed application — reinstallable, but you lose preferences and local data unless backed up",
        "Reinstall from the vendor or Mac App Store, then re-sign in",
    ),
    CleanupRule(
        "*/.cursor/extensions",
        "ide_state",
    ...
    CleanupRule(
        ...
        "Re-downloaded on next `pnpm install`",
    ),
    CleanupRule(
        ...
        "mdimport rebuilds the index lazily on next search",
    ),
    CleanupRule(
        ...
        "safe",
        "delete",
        "Interface Builder compiled-nib cache",
        "Xcode rebuilds on next IB compile",
    ),
    CleanupRule(
        "*/.rvm/src",
        "package_manager",
        ...
        "safe",
        "delete",
        "RVM Ruby source tarballs from past installs, not read after install",
        "Re-downloaded if you re-install a Ruby version",
    ),
    CleanupRule(
        "*/Library/Caches",
        "cache",
    ...
    CleanupRule(
        ...
        "safe",
        "delete",
        "Xcode SwiftPM resolved checkouts and artifacts",
        "Xcode re-resolves on next build",
    ),
    CleanupRule(
        "*/build/Build",
        "build_artifact",
        ...
        "safe",
        "delete",
        "Xcode workspace-local build output (project-level DerivedData equivalent)",
        "Xcode regenerates on next build",
    ),
    CleanupRule(
        "*/Library/Android/sdk",
        "dev_tools",
        ...
        "low",
        "review",
        "Android SDK — re-downloadable via Android Studio's SDK Manager",
        "Open Android Studio → SDK Manager and re-install needed components",
    ),
    CleanupRule(
        "*/.rvm/gems",
        "package_manager",
        ...
        "low",
        "review",
        "RVM-installed Ruby gems, per Ruby version",
        "Reinstall via `gem install` or `bundle install` per project",
    ),
]
